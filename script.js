document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        { name: "Kalsium Original", desc: "Rasa gurih klasik yang autentik, cemilan sehat kaya kalsium.", msg: "Halo Admin, saya ingin memesan Kerupuk Kalsium Original" },
        { name: "Pedas Daun Jeruk", desc: "Sensasi pedas nendang dengan aroma daun jeruk yang segar.", msg: "Halo Admin, saya ingin memesan Kerupuk Pedas Daun Jeruk" }
    ];
    ...
    function renderSlide(index) {
        ...
        if(waLinkEl) waLinkEl.href = `https://wa.me/+6287754104332?text=${encodeURIComponent(products[currentIndex].msg)}`;
    }
